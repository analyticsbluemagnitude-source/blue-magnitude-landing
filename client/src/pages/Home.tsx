  ...
  return (
    <div className="min-h-screen">
      ...
      <a
        ...
        className="fixed right-8 top-1/2 -translate-y-1/2 z-50 bg-[#25D366] hover:bg-[#1eaa50] text-white rounded-full p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
