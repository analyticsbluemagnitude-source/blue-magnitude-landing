...
- [x] Criar modal de confirmação visual após envio de formulário
- [x] Adicionar informações sobre próximos passos no modal
- [x] Integrar modal com formulários de Orçamento e Contacto
...
- [ ] Implementar envio de email ao preencher formulário de orçamento
- [ ] Criar procedimento tRPC para receber dados do formulário
- [ ] Configurar envio de email para geral@bluemagnitude.pt
- [ ] Conectar formulário do frontend ao backend
- [x] Melhorar sistema de notificações toast com estilos personalizados
